  ...
  return (
    <>
      ...
      <div className="px-4 py-4 mt-auto border-t border-gray-200">
        <SidebarLink href="#" currentPath={currentPath} icon={<LifeBuoy className="mr-3 h-5 w-5" />}>Support</SidebarLink>
      </div>
    </>
  );
};
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 flex-shrink-0">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            <Button variant="ghost" size="icon" onClick={handleFeatureClick}><Search className="h-5 w-5 text-gray-600" /></Button>
            <Button variant="ghost" size="icon" onClick={handleFeatureClick}><Bell className="h-5 w-5 text-gray-600" /></Button>
